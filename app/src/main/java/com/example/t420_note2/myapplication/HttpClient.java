...
/**
 * Created by T420_Note2 on 2017-03-05.
 */
...
//    private static final String WWW_FORM = "application/soap+xml; charset=utf-8";
    ...
    public void request() {
        ...
        try {
            ...
            Log.d("aa", "connection code : " + status);
            if (status != HttpURLConnection.HTTP_OK) {
                body = conn.getErrorStream().toString();
                Log.d("aa", "getErrorStream : " + body);
            }
        }
        catch(Exception e){}
    ...
    private void setBody(HttpURLConnection connection) {
        ...
        Log.d("aa", "setBody parameter : " + parameter);
    ...
    public static class Builder {
        ...
        public String getParameters() {
            ...
            return generateParametersByJSON();
        }
        ...
        private String generateParametersByJSON() {
            //StringBuffer parameters = new StringBuffer();
            Iterator<String> keys = getKeys();
            String key = "";
            ...
            while (keys.hasNext()) {
                key = (String)keys.next();
                try {
                    jsonObject.accumulate(key, this.parameters.get(key));
                }
