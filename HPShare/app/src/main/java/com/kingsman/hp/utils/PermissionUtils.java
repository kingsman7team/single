...
public abstract class PermissionUtils {
    ...
    public static class RationaleDialog extends DialogFragment {
         ...
         *                       cancelled.
         */
        public static RationaleDialog newInstance(int requestCode, String permission, boolean finishActivity) {
            Bundle arguments = new Bundle();
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage(getResources().getString(R.string.permission_rationale, mPermission))
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (mFinishActivity) {
                Toast.makeText(getActivity(),
                        getResources().getString(R.string.permission_required_toast, mPermission, mPermission),
                        Toast.LENGTH_SHORT)
                        .show();
                getActivity().finish();
            }
